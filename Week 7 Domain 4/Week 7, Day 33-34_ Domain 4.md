...
* **SIEM vs. SOAR:**  
  * **SIEM:** Centralizes and correlates logs to generate security alerts (passive detection).  
  * **SOAR:** Automates incident response using playbooks and runbooks (active response).  
* **NetFlow / IPFIX:** Captures traffic metadata (IPs, ports, protocols, volume) without full packet payloads.  
* **Syslog Standards:**  
  * **UDP 514:** Unencrypted cleartext logging.  
  * **TCP 6514:** Encrypted logging over TLS.
